        ...
        >
          {({ isActive }) => (
            <>
              ...
              <span className={`text-xs mt-1 ${isActive ? 'font-semibold' : 'font-medium'}`}>Inicio</span>
            </>
          )}
        </NavLink>
        ...
        >
          {({ isActive }) => (
            <>
              ...
              <span className={`text-xs mt-1 ${isActive ? 'font-semibold' : 'font-medium'}`}>Categorías</span>
            </>
          )}
        </NavLink>
        ...
        >
          {({ isActive }) => (
            <>
              ...
              <span className={`text-xs mt-1 ${isActive ? 'font-semibold' : 'font-medium'}`}>Productos</span>
            </>
          )}
        </NavLink>
        ...
        >
          {({ isActive }) => (
            <>
              ...
              <span className={`text-xs mt-1 ${isActive ? 'font-semibold' : 'font-medium'}`}>Carrito</span>
            </>
          )}
        </NavLink>
        ...
        >
          {({ isActive }) => (
            <>
              ...
              <span className={`text-xs mt-1 ${isActive ? 'font-semibold' : 'font-medium'}`}>Perfil</span>
            </>
          )}
        </NavLink>
      </nav>
